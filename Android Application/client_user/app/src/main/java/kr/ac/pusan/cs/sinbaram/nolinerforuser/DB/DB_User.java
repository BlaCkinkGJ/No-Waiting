...
public class DB_User extends SQLiteOpenHelper implements DB{
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE USER_INFO (_id INTEGER PRIMARY KEY, list_name TEXT, user_id TEXT, cur_time TEXT );");
    }
    ...
    public void insert(String[] values){
        ...
        db.execSQL("INSERT INTO USER_INFO VALUES(null, '"+listName+"', '"+ userID + "', '"+ currentTime +"');");
        db.close();
    }
