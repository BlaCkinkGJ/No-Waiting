...
public class Activity_QRactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Obj_User user = (Obj_User)intent.getSerializableExtra("regist");
            ...
            public void onClick(View view) {
                mRef.child("Obj_Line List").child(public_ID).child(line.Line_Name).child("USER LIST").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(key != null) {
                            DB.delete(line_Name);
                            mRef.child("Obj_Line List").child(public_ID).child(line_Name).child("USER LIST").child(key).setValue(null);
                            mRef.child("Obj_Line List").child(public_ID).child(line_Name).child("INFO").child("Current_Enrollment_State").setValue(line.Current_Enrollment_State - 1);
                        }
                    }
                ...
                Toast.makeText(Activity_QRactivity.this,"취소되었습니다.",Toast.LENGTH_LONG).show();
                finish();
            }
        });
